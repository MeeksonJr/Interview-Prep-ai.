...
const PAYPAL_CLIENT_ID = process.env.PAYPAL_CLIENT_ID ||"ARQR8KMPxuqn4obXkPyzOcssn5kuJV251NR-XM5_mwB1id5joWCqAFqv573hsOeU3tEg3Zr7aO_tlEj4"
const PAYPAL_CLIENT_SECRET = process.env.PAYPAL_CLIENT_SECRET || "EAjmka0sP_035eWq7ZrbgVSthJkK-AoJRKy8cwrTB4io76caJ2YWstpv8iz0diz_vI6xIHBTWj_mvUrp"
const PAYPAL_API_BASE = process.env.PAYPAL_API_URL||"https://api-m.sandbox.paypal.com" // Use sandbox for testing
